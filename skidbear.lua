...
local FolderName = "DRGX hub | Farm"
...
local bearlib = loadstring(game:HttpGet("https://raw.githubusercontent.com/LeMinh2k12/selenecrack/refs/heads/main/lib.lua"))()
local Window = bearlib:MakeWindow({
    Title = "DRGX hub | Farm",
    SubTitle = "skid by NoName X DRGX hub Dev",
    SaveFolder = true,
...
"NoName X DRGX hub ",
        "Follow our Discord channel for the latest updates!!!",
...
-- =========================================================
-- AUTO FISHING SYSTEM (Ported from DRGX hub)
-- =========================================================
        ...
        pcall(function()
            while wait(Sec) do
                if _G.Auto_Rainbow_Haki then
                    -- Copy logic Rainbow Haki từ file DRGX hub.txt (dòng 2058-2154) vào đây nếu cần
